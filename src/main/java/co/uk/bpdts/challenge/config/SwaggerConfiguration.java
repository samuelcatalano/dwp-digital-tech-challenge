...
public class SwaggerConfiguration {
    ...
    public static final String BASE_PACKAGE = "co.uk.bpdts.challenge";
    ...
    private ApiInfo customApiInfo() {
        return new ApiInfoBuilder().title("Bpdts Code Challenge")
                .description("Bpdts Management OPEN REST API")
